...
screen main_menu():
    ...
    frame:
        ...
        add "title"
        imagebutton:
            auto "images/UI/button_image1_%s.png"
            action Start()
            xpos 100 ypos 800
            hover_sound "sfx/click.wav"
        imagebutton:
            auto "images/UI/button_image2_%s.png"
            action ShowMenu("load")
            xpos 550 ypos 800
            hover_sound "sfx/click.wav"
        imagebutton:
            auto "images/UI/button_image3_%s.png"
            action ShowMenu("preferences")
            xpos 1000 ypos 800
            hover_sound "sfx/click.wav"
        imagebutton:
            auto "images/UI/button_image4_%s.png"
